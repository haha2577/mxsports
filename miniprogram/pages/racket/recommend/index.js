...
Page({
  ...
  onLoad(){
    ...
    this.setData({sport,sportPref:pref,heroGrad:sport==='badminton'?GRAD_B:GRAD_T,rackets:RACKETS[sport]||[]})
  },
  onSwitchSport(e){const s=e.detail;wx.setStorageSync('activeSport',s);this.setData({sport:s,heroGrad:s==='badminton'?GRAD_B:GRAD_T,rackets:RACKETS[s]||[]})},
