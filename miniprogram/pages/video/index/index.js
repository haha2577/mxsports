...
Page({
  ...
  onLoad(){
    ...
    this.setData({activeSport:sport,sportPref:pref,heroGrad:sport==='badminton'?GRAD_B:GRAD_T})
  },
  get videos(){return(this.data.videos||[]).filter(v=>v.sport===this.data.activeSport)},
  onSwitchSport(e){const s=e.detail;wx.setStorageSync('activeSport',s);this.setData({activeSport:s,heroGrad:s==='badminton'?GRAD_B:GRAD_T})},
